...
public class ZendeskService {
    ...
    public String altaTicketZendesk(UsuarioAlta usuarioAlta, String userAgent){
        ...
        StringBuilder datosUsuario = setDatosUsuario(usuarioAlta, userAgent);
        ...
        try{
            obtenerDatosCliente(datosBravo, idCliente);
        }catch(Exception e)
        {
	...
	private void obtenerDatosCliente(StringBuilder datosBravo, String idCliente) throws ParseException {
		...
		annadirDatosBravoTipoCliente(datosBravo, cliente);
	...
	private void annadirDatosBravoTipoCliente(StringBuilder datosBravo, DatosCliente cliente) {
	...
	private StringBuilder setDatosUsuario(UsuarioAlta usuarioAlta, String userAgent) {
